...
public class Main{
    ...
    public static void main(String[] args){					
        ...
        //Read the number of self-check servers
        ...
        //Read the resting rate
        double restRate = sc.nextDouble();

        //Read the probability of resting
        double restProbability = sc.nextDouble();

        Simulator s = new Simulator(seedValue, numServers, numSelfServers, maxQueue, numCustomers, arrivalRate, serviceRate, restRate, restProbability);
        s.startSimulation();
        s.getStats();	
    }
}
