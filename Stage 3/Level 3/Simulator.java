...
public class Simulator{
     ...
     */	
    public Simulator(int seedValue, int numServers, int numSelfServers, int maxQueue, int numCustomers, double arrivalRate, double serviceRate, double restRate, double restProbability){
        ...
        while (queue.size() != 0){
            ...
            /*case D: 
              ...
              getState -> State.DONE;*/
                  ...
                  /*if currentServer is a SelfServer or the HumanServer doesnot need a break;
