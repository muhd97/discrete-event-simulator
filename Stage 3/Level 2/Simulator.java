...
public class Simulator{
     ...
     */	
    public Simulator(int seedValue, int numServers, int maxQueue, int numCustomers, double arrivalRate, double serviceRate, double restRate, double restProbability){
        ...
        while (queue.size() != 0){
            ...
            /*case D: 
              ...
              getState -> State.DONE;*/
                  ...
                  numCustomersServed++;
                  //check for server's break
                  if(randomGen.genRandomRest() < restProbability){
                  ...
                  /*if server  doesnot need a break;
